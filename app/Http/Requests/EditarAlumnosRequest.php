...
class EditarAlumnosRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'codigo' => [ 'required', 'numeric', Rule::unique('alumnos', 'codigo')->ignore($alumnoId), ],
            'nombre' => 'required|string|max:255',
            'correo' => [ 'required', 'email', 'max:255', Rule::unique('alumnos', 'correo')->ignore($alumnoId), ],
            'fecha_nacimiento' => 'required|date|before_or_equal:today',
            'sexo' => [ 'required', 'string', Rule::in(['masculino', 'femenino', 'prefiero_no_decirlo']),],
